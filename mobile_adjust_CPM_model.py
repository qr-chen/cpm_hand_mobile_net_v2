...
class CPM_v2(g.nn.HybridBlock):
    def __init__(self, stages, joints, width_mult=1):
        super(CPM_v2, self).__init__()
        ...
        self.last_channels = int(1280 * self.w) if self.w > 1.0 else 1280  # 1280
    ...
    def forward(self, x):
        ...
        self.totol_heatmap = mx.ndarray.concat(
